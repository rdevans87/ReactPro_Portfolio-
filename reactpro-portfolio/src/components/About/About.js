...
function About() {
  return (
    <section className="about">
      ...
      <br></br>
       View or Download my full <a href="http://localhost:52330/reactpro-portfolio/src/assets/PorfolioResume_RyanEvans.pdf" width="20px" rel="noreferrer" target="_blank">Resume.</a>
